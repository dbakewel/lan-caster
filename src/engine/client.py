...
class Client(dict):
    ...
    def setMapOffset(self, map):
        ...
        """
        mapOffsetX = -map['borderWidth']
        mapOffsetY = -map['borderWidth']
        ...
        if map['pixelWidth'] > self['screen'].get_width() or map['pixelHeight'] > self['screen'].get_height():
            ...
            if map['pixelWidth'] > self['screen'].get_width():
                mapOffsetX = self['screen'].get_width() / 2 - sprite['anchorX'] - map['borderWidth']
                if mapOffsetX > 0:
                    mapOffsetX = 0
            ...
            if map['pixelHeight'] > self['screen'].get_height():
                mapOffsetY = self['screen'].get_height() / 2 - sprite['anchorY'] - map['borderWidth']
                if mapOffsetY > 0:
                    mapOffsetY = 0
